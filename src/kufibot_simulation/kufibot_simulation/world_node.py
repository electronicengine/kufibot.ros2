...
class WorldNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('body_radius_m', 0.20)
    ...
    def _tick(self):
        ...
        hit = self.floorplan.raycast(self.x, self.y, lidar_bearing,
    ...
    def _publish_camera(self):
        ...
        frame = renderer.render(self.floorplan, self.x, self.y, bearing,
