"""HTTP client for the Verasist REST API.
...
class VerasistClient(_GeneratedClient):
    ...
    def __init__(
        ...
        *,
        ...
        resolved_url = base_url or os.environ.get(
            "VERASIST_API_URL", "http://localhost:8000"
        )
        self.base_url = resolved_url.rstrip("/")
        self.api_key = api_key or os.environ.get("VERASIST_API_KEY")
    ...
    def __enter__(self) -> VerasistClient:
        return self
